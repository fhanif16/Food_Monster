...
let foodIngredients = ingredients => {
    ...
    fetch(`https://www.themealdb.com/api/json/v1/1/lookup.php?i=${ingredients}`)
        ...
        .then(data => {
           ...
           <h4 class="header"> Food Area:</h1>
           <p>${foodsIngi.strArea}</p1>
          <br>
          <h4 class="header">Food Types</h4>
          <p1>${foodsIngi.strMeal}</p1>
           <br>
           <h4 class="header">Food Tags</h4>
           <p1>${foodsIngi.strTags}</p1>
            <br>
           <h4 class="header"> Main Ingredient: </h2>
           <p1>${foodsIngi.strCategory}</p1>
           <br>
           <h4 class="header"> Food Ingredient:</h1>
           ...
           <br>
           <h4 class="header"> Food Measurement:</h1>
           <p1> ${foodsIngi.strMeasure1}</p1>
           <br>
           <p1> ${foodsIngi.strMeasure2}</p1>
           <br>
           <p1> ${foodsIngi.strMeasure3}</p1>
           <br>
           <p1> ${foodsIngi.strMeasure4}</p1>
           <br>
           <p1> ${foodsIngi.strMeasure5}</p1>
           <br>
           <p1> ${foodsIngi.strMeasure6}</p1>
           <br>
